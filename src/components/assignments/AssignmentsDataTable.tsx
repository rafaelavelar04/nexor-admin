...
export function AssignmentsDataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">Nenhuma alocação encontrada.</TableCell>
              </TableRow>
            )}
          </TableBody>
        </Table>
