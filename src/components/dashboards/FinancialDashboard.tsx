...
import { Loader2, DollarSign, Percent, PiggyBank, AlertTriangle } from 'lucide-react';
...
const FinancialDashboard = ({ dateRange }: FinancialDashboardProps) => {
    ...
    return (
      <div className="mt-6 p-6 border border-destructive/50 bg-destructive/10 rounded-lg text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um erro ao buscar as informações financeiras. Isso pode ser devido a um problema de permissão ou uma falha temporária.
        </p>
  ...
  if (!data || Object.keys(data).length === 0 || !data.revenue_vs_costs_chart) {
    return (
      <div className="mt-6">
