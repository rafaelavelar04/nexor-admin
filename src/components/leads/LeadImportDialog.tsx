  ...
  const handleImport = () => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        const requiredColumns = ['nome', 'empresa', 'nicho'];
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Selecione um arquivo .csv ou .xlsx para importar uma lista de leads.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <Alert>
            ...
            <AlertDescription>
              Importe uma planilha no mesmo formato da exportação para adicionar leads automaticamente. As colunas obrigatórias são: <strong>nome, empresa, nicho</strong>.
            </AlertDescription>
          </Alert>
          <Input
            type="file"
