...
const ProfileSettings = () => {
  ...
  const profileUpdateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['sessionProfile'] }); // A custom key to refetch session
    },
  ...
  const avatarUpdateMutation = useMutation({
    ...
    onError: (error: any) => showError(`Erro ao atualizar avatar: ${error.message}`),
  });
